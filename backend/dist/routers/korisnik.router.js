...
korisnikRouter.route('/login').post((req, res) => new korisnik_controller_1.default().login(req, res));
korisnikRouter.route('/dohvati_sve').post((req, res) => new korisnik_controller_1.default().dohvati_sve(req, res));
